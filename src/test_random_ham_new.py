...
# %%time
evals = core.dacp_eig(
    H, a=0.1, eps=0.05, random_vectors=2, return_eigenvectors=False, filter_order=12
)

# %%time
true_vals=eigsh(H, return_eigenvectors=False, sigma=0, k=evals.shape[0])
...
# %%time
evals=core.dacp_eig(H, a=0.1, eps=0.05, random_vectors=2, return_eigenvectors=False, filter_order=12)
